...
#Form Validation: Display all form_errors:

	
#create Custom Form Validation:
# Create two file to the Custom Constraint:
	#AppBundle\Validator\Constraints\ElementArrivage.php:
		<?php
	...
	#AppBundle\Validator\Constraints\ElementArrivageValidator.php:
		<?php
...
Bug : Why errors from custom validation constrain not attached to specific field by to the form?
Solution: 
...
#set Symfony timezone => Tunisie: (timezone PHP)
	#app/AppKernel.php:
...
#Routing JS + Form Event Listener:
	https://www.youtube.com/watch?v=KNppHj_PRSA

#show all routes 
	php bin/console debug:router
	
#Resolve ignoring updating Collection Listener of vente in Client:
	#Entity Vente:
